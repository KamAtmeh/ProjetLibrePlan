...
//        Reader readerBackupSchema = new BufferedReader(new FileReader("src/test/resources/database/backupSchemaLibrePlan.sql"));
//        Reader readerBackupData = new BufferedReader(new FileReader("src/test/resources/database/backupDataLibrePlan.sql"));
//        //Running the script
//        sr.runScript(readerBackupSchema);
//        sr.runScript(readerBackupData);
